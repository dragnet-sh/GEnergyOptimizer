...
extension RoomListViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        //ToDo: Safely UnWrap
        if let roomList = state.getPFAudit()?.roomCollection {
