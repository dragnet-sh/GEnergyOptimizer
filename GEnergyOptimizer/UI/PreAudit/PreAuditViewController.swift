...
extension PreAuditViewController {
    ...
    fileprivate func loadFormData() {
        ...
        for (elementId, data) in preAuditDTO.data {
    ...
    fileprivate func saveFormData() {
        ...
        formData.forEach { tuple in
            ...
            if let value = tuple.value {
                ...
                preAuditDTO.data[tuple.key] = [idToElement![tuple.key]?.param, value] //ToDo: Forced Unwrapping - Recipe for disaster
            }
        }
