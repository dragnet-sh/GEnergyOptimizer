...
class HomeListCell: UITableViewCell {
    ...
    func configureWithData(data: HomeListViewController.HomeListDataModel) {
...
extension HomeListCell {
    ...
    public static func dequeue(from tableView: UITableView, for indexPath: IndexPath, with homeListDataModel: HomeListViewController.HomeListDataModel) -> HomeListCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: HomeListCell.cellId, for: indexPath) as! HomeListCell
        cell.configureWithData(data: homeListDataModel) //ToDo: The configuration method to be pulled onto the Presenter
